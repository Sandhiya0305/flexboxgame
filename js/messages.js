var messages = {
  ...
  labelFooter: {
    ...
    'af': 'Flexbox Fairy is ontwerp deur',
    'he': 'Flexbox Fairy נוצר על ידי',
    'ro': 'Flexbox Fairy este creat de',
    'sr': 'Flexbox Fairy је направио',
    'bs': 'Flexbox Fairy je napravio',
    'hr': 'Flexbox Fairy je stvorio',
    'bg': 'Flexbox Fairy е създадена от',
    'de': 'Flexbox Fairy wurde gemacht von',
    'fr': 'Flexbox Fairy est créé par',
    'pt-br': 'Flexbox Fairy foi criado por',
    'es': 'Flexbox Fairy es una creación de',
    'ru': 'Игра Flexbox Fairy создана',
    'fa': 'قورباغه فلکس باکس ساخته شده توسط',
    'zh-cn': 'Flexbox Fairy的作者是',
    'zh-tw': 'Flexbox Fairy的作者是',
    'tr': 'Flexbox Fairy\'nin yaratıcısı:',
    'az': 'Flexbox Fairy\'nin qurucusu:',
    'it': 'Flexbox Fairy è stato creato da',
    'ko': 'Flexbox Fairy는 다음에 의해 개발되었습니다',
    'lt': 'Flexbox Fairy kūrėjas',
    'vi': 'Flexbox Fairy được tạo ra bởi',
    'pl': 'Flexbox Fairy jest wytworem',
    'cs': 'Flexbox Fairy vytvořil',
    'ja': 'Flexbox Fairy is created by',
    'hu': 'A Flexbox Fairy-t készítette',
    'eo': 'Flexbox Fairy far',
    'sv': 'Flexbox Fairy skapades av',
    'uk': 'Гру Flexbox Fairy створено',
    'hi': 'Flexbox Fairy के निर्माणकर्ता ',
    'gj': 'Flexbox Fairy ના નિર્માણકર્તા ',
    'nl': 'Flexbox Fairy is gemaakt door',
    'ta': 'Flexbox Fairy உருவாக்கியவர்',
    'te': 'Flexbox Fairy చేసిన వారు',
    'ml': 'Flexbox Fairy സൃഷ്ടിച്ചത്',
    'el': 'Το Flexbox Fairy δημιουργήθηκε από',
    'mk': 'Flexbox Fairy е создадено од',
    'lv': 'Flexbox Fairy autori ir',
    'id': 'Flexbox Fairy dibuat oleh',
    'ar': 'تم انشاء فروغي فلكسبكس بواسطة',
    'ca': 'Flexbox Fairy és una creació de',
    'da': 'Flexbox Fairy er skabt af',
    'et': 'Flexbox Fairy on looja on',
    'fi': 'Flexbox Fairyn on tehnyt',
    'gl': 'Flexbox Fairy creouno',
    'th': 'Flexbox Fairy ถูกสร้างโดย',
    'mn': 'Flexbox Fairy is created by',
    'sk': 'Flexbox Fairy vytvoril',
    'si': 'Flexbox මැඬියා නිර්මාණය කළේ',
    'bn': 'Flexbox Fairy তৈরি করেছে',
    'np': 'Flexbox Fairy को निर्माता',
    'my': 'Flexbox Fairy ကို ဖန်တီးခဲ့သည်',
    'yo': 'Àwọn tó dá ẹ̀dá Flexbox Fairy ní',
    'no': 'Flexbox Fairy er laget av',
  },
  labelLevel: {
    'en': 'Level',
    'af': 'Vlak',
  ...
  title: {
    ...
    'af': 'Flexbox Fairy - `n Spel vir die leer van CSS flexbox',
    'he': 'Flexbox Fairy - משחק ללמידת CSS flexbox',
    'ro': 'Flexbox Fairy - Un joc pentru a învăța CSS flexbox',
    'sr': 'Flexbox Fairy - Игра за учење CSS flexbox-а',
    'bs': 'Flexbox Fairy - Igra za učenje CSS flexbox-a',
    'hr': 'Flexbox Fairy - Igra za učenje CSS flexboxa',
    'bg': 'Flexbox Fairy - Игра за учене на CSS flexbox',
    'de': 'Flexbox Fairy - Ein Spiel, um CSS flexbox zu lernen',
    'fr': 'Flexbox Fairy - Un jeu pour apprendre les flexbox CSS',
    'pt-br': 'Flexbox Fairy - Um jogo para aprender CSS flexbox',
    'es': 'Flexbox Fairy - Un juego para aprender CSS flexbox',
    'ru': 'Flexbox Fairy - игра для изучения CSS flexbox',
    'fa': 'قورباغه فلکس باکس - یک بازی جذاب برای آموزش سی اس اس فلکس باکس',
    'zh-cn': 'Flexbox Fairy - 一个用来学CSS flexbox的游戏',
    'zh-tw': 'Flexbox Fairy - 一個用來學CSS flexbox的遊戲',
    'tr': 'Flexbox Fairy - CSS flexbox için öğretici oyun',
    'az': 'Flexbox Fairy - CSS flexbox üçün öyrədici oyun',
    'it': 'Flexbox Fairy - Un gioco per imparare CSS flexbox',
    'ko': 'Flexbox Fairy - CSS flexbox 속성 배우기 게임',
    'lt': 'Flexbox Fairy - Žaidimas padėsiantis perprasti CSS "flexbox" metodiką',
    'vi': 'Flexbox Fairy - Một trò chơi để học CSS flexbox',
    'pl': 'Flexbox Fairy - Gra wprowadzająca do CSS flexbox"',
    'cs': 'Flexbox Fairy - CSS flexbox hrou',
    'ja': 'Flexbox Fairy - CSS flexbox学習ゲーム',
    'hu': 'Flexbox Fairy - Játékos CSS flexbox tanulás',
    'eo': 'Flexbox Fairy - Ludo por lerni CSS flexbox-on',
    'sv': 'Flexbox Fairy - Ett spel för att lära sig CSS flexbox',
    'uk': 'Flexbox Fairy - гра для вивчення CSS flexbox',
    'hi': 'Flexbox Fairy - CSS Flexbox सीखने के लिए एक खेल',
    'gj': 'Flexbox Fairy - CSS Flexbox  શીખવા માટેની એક રમત',
    'nl': 'Flexbox Fairy - Een spel om CSS flexbox te leren',
    'ta': 'Flexbox Fairy - CSS flexbox கற்றல் விளையாட்டு',
    'te': 'Flexbox Fairy - CSS Flexbox నేర్చుకోవడానికి ఒక ఆట',
    'ml': 'Flexbox Fairy - CSS Flexbox പഠിക്കാം',
    'el': 'Flexbox Fairy - Ένα παιχνίδι για την εκμάθηση του CSS Flexbox',
    'mk': 'Flexbox Fairy - Игра за учење на CSS flexbox',
    'lv': 'Flexbox Fairy - Spēle, kas Tev palīdzēs iemācīties CSS Flexbox',
    'id': 'Flexbox Fairy - Sebuah permainan untuk belajar CSS flexbox',
    'ar': 'فروغي فلكسبكس - لعبة لتعلم الفلكسبكس في CSS',
    'ca': 'Flexbox Fairy - Un joc per aprendre CSS Flexbox',
    'da': 'Flexbox Fairy - Et spil, der lærer dig CSS Flexbox',
    'et': 'Flexbox Fairy - Mäng CSS flexbox\'i õppimiseks',
    'fi': 'Flexbox Fairy - Peli, jossa opit CSS flexbox -asettelun',
    'gl': 'Flexbox Fairy - Un xogo para aprenderes CSS Flexbox',
    'th': 'Flexbox Fairy - เกมสำหรับเรียนรู้ CSS Flexbox',
    'mn': 'Flexbox Fairy - CSS flexbox-г сурах тоглоом',
    'sk': 'Flexbox Fairy - Hra na učenie CSS flexbox',
    'si': 'Flexbox මැඬියා - CSS flexbox ඉගෙනීමේ ක්‍රීඩාවක්',
    'bn': 'Flexbox Fairy - CSS flexbox শেখার একটি গেইম',
    'np': 'Flexbox Fairy - CSS Flexbox सिक्नको लागि एउटा खेल',
    'my': 'Flexbox Fairy - CSS flexbox သင်ယူရန် ဂိမ်းတစ်ခု',
    'yo': 'Flexbox Fairy - Eré tí ẹ̀yàń lè fi kọ́ ẹ̀kọ́ flexbox CSS',
    'no': 'Flexbox Fairy - Et spill for å lære CSS flexbox'
  },
  labelReset: {
    'en': 'Reset',
    'af': 'Herstel',
